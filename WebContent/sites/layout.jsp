	...
	<header id="header" class="page-header bg-white b-b">
		<div class="navbar navbar-expand-lg">
			...
			<a href="home" class="navbar-brand w w-auto-sm"> <svg width="32" height="32" viewBox="0 0 512 512"
                ...
                </svg><span class="hidden-folded d-inline l-s-n-1x w w-auto-sm">NGHIENPHIM</span>
			</a>
			<!-- / brand -->
			<!-- Navbar collapse -->
					...
					<div class="nav-border b-primary" data-nav>
						<ul class="nav bg">
							...
							<li><a href="myfavorite" class="nav-text"><span class="nav-icon"><i data-feather="star"></i></span>My
									favorites</a></li>
							<c:if test="${isLogin}">
								<li><a href="admin/home" class="nav-text" target="_blank"><span class="nav-icon"><i data-feather="command"></i></span>Admin
										Management</a></li>
							</c:if>
						</ul>
					</div>
